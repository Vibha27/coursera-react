                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                                ...
                                <Col md={10}>
                                   ...
                                   <Errors 
                                    ...
                                    messages={{
                                        ...
                                        maxLength:"Must be of 15characters or less"
                                    }}
                                   /> 
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    messages={{
                                        ...
                                        maxLength:"Must be of 15numbers or less",
                                        isNumber:"Must be a number only"
                                    }}
                                   /> 
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    name="message" className="form-control" row="12" />
                                </Col>
                            </Row>
